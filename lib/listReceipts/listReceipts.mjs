...
export const handler = async (event) => {
    ...
    try {
        ...
        // const shopperID = "c4f85428-a0f1-70aa-bd7b-f6169dfde1c5"; // for testing

        console.log("shopperId " + shopperID); // test

        console.log("authorizer object:", JSON.stringify(event?.requestContext?.authorizer, null, 2)); // test

        const receipts = await getReceipts(connection, shopperID);

        console.log("receipts: " + receipts); // test
        ...
        console.log("receiptList: " + receiptList); // test
