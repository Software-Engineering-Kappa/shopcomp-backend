...
interface AddItemToShoppingListStackProps extends cdk.StackProps {
...
export class AddItemToShoppingListStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: AddItemToShoppingListStackProps) {
    super(scope, id, props)

    // BEGIN: /shopping_lists/{shoppingListID}/items endpoint

    const addItemToShoppingListFn = new lambdaNodejs.NodejsFunction(this, "addItemToShoppingList", {
      runtime: lambda.Runtime.NODEJS_22_X,
      handler: "addItemToShoppingList.handler",
      code: lambda.Code.fromAsset(path.join(__dirname, "addItemToShoppingList")),
      vpc: props!.vpc,
    ...
    itemsResource.addMethod("POST", new apigw.LambdaIntegration(addItemToShoppingListFn), {
