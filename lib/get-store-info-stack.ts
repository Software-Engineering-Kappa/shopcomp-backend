...
interface GetStoreInfoStackProps extends cdk.StackProps {
...
export class GetStoreInfoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: GetStoreInfoStackProps) {
    super(scope, id, props)

    // BEGIN: /chains/{chainId}/stores/{storeId} endpoint

    const getStoreInfoFn = new lambdaNodejs.NodejsFunction(this, "getStoreInfo", {
      runtime: lambda.Runtime.NODEJS_22_X,
      handler: "getStoreInfo.handler",
      code: lambda.Code.fromAsset(path.join(__dirname, "getStoreInfo")),
      vpc: props!.vpc,
