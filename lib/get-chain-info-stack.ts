...
interface GetChainInfoStackProps extends cdk.StackProps {
...
export class GetChainInfoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: GetChainInfoStackProps) {
    ...
    const getChainInfoFn = new lambdaNodejs.NodejsFunction(this, "getChainInfo", {
      ...
      handler: "getChainInfo.handler",
      code: lambda.Code.fromAsset(path.join(__dirname, "getChainInfo")),
      vpc: props!.vpc,
